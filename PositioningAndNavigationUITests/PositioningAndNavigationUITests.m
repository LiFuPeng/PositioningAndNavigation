//
//  PositioningAndNavigationUITests.m
//  PositioningAndNavigationUITests
//
...
@interface PositioningAndNavigationUITests : XCTestCase

@end

@implementation PositioningAndNavigationUITests
